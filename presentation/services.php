...
<head>
    ...
    <title>Services IMS Computers</title>
    <style>
        /* Reset global */
        * {
        ...
        @media (max-width: 768px) {
            /* Réduction des marges et du padding pour le carrousel */
            .carousel-container {
                margin: 20px 0;
                padding: 10px;
            }

            /* Le carrousel devient défilable en horizontal */
            .carousel {
                overflow-x: auto;
            ...
            /* Ajuster le header pour les petits écrans */
            .header {
                height: auto;
            }
        ...
        <div class="carousel">
            ...
            <div class="service-card">
                ...
                <div class="service-content">
                    ...
                    <p>Diagnostic rapide et réparation efficace de votre PC.En toute securité.</p>
