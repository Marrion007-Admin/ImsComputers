                ...
                <div class="collapse navbar-collapse justify-content-center mt-4 p-2 div1-collapse" id="navbarNav">
                    <ul class="navbar-nav justify-content-center border border-white border-2 rounded-2 p-1">
                        ...
                        <li class="nav-item px-4 text-white">
                            <a class="nav-link text-white" href="presentation/contact.php">Contact</a>
                        </li>
                        <li class="nav-item px-4 ">
                            <a class="nav-link text-white" href="presentation/services.php">Services</a>
                        </li>
                        <li class="nav-item px-4 ">
                            <a href="presentation/about.php" class="nav-link text-white">A Propos</a>
                        </li>
                        <li class="nav-item px-3 ps-4 ">
                            <a href="presentation/agent.php" class="nav-link text-white ">Agents</a>
                        </li>
                    </ul>
                </div>
            </header>
